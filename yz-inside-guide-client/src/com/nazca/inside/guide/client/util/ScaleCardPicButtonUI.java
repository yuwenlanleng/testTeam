...
public class ScaleCardPicButtonUI extends BasicButtonUI {
    ...
    public ScaleCardPicButtonUI(ScalePicBtnEnum btnEnum) {
        ...
        temp[0] = Jk2cMmgtResourceUtil.readImage(btnEnum.name() + pressedSuffix);
        temp[1] = Jk2cMmgtResourceUtil.readImage(btnEnum.name() + hoverSuffix);
        temp[2] = Jk2cMmgtResourceUtil.readImage(btnEnum.name() + normalSuffix);
        if (btnEnum.equals(ScalePicBtnEnum.big) || btnEnum.equals(ScalePicBtnEnum.small)) {
            temp[3] = Jk2cMmgtResourceUtil.readImage(btnEnum.name() + forbiddenSuffix);
        }
    }
